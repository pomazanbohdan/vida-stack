...
Purpose: provide a clean project docs map scaffold for the repository being developed on top of the VIDA framework.
...
5. Keep project/product pointers here, not in framework-owned map/index surfaces under `vida/config/instructions/**`.
...
updated_at: '2026-03-12T12:20:00+02:00'
