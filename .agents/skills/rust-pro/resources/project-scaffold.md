...
Complete project structures with cargo tooling, proper module organization, testing setup, and configuration following Rust best practices.
...
| **Web API** | Axum/Actix web services, REST APIs |
