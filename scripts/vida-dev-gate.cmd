...
set "PATH=%SystemRoot%\System32;%SystemRoot%;%SystemRoot%\System32\Wbem;%SystemRoot%\System32\WindowsPowerShell\v1.0;%ProgramFiles%\PowerShell\7;%ProgramFiles%\WindowsApps;%LOCALAPPDATA%\Microsoft\WindowsApps;%USERPROFILE%\.cargo\bin;C:\Users\%USERNAME%\.cargo\bin;%PATH%"
...
if not defined PWSH (
  echo [vida-dev-gate] ERROR: neither pwsh.exe nor powershell.exe was found after Windows PATH bootstrap. 1>&2
  exit /b 1
)
