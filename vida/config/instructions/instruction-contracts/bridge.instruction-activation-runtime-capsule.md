...
2. the canonical owner remains `vida/config/instructions/instruction-contracts/bridge.instruction-activation-protocol.md`,
...
3. external facts can change the decision:
   - `work.web-validation-protocol.md`
4. visible skill catalog or skill-bound work:
   - `core.skill-activation-protocol.md`
5. packet shaping / leaf-depth selection:
   - `core.packet-decomposition-protocol.md`
6. worker packet / handoff / next-agent prompt work:
   - `lane.agent-handoff-context-protocol.md`
7. tracked execution with multiple lawful next items:
   - `work.execution-priority-protocol.md`
8. silent diagnosis enabled:
   - `analysis.silent-framework-diagnosis-protocol.md`
9. restart / checkpoint / replay / resumability:
...
updated_at: '2026-03-13T22:25:00+02:00'
