...
2. `vida/config/instructions/diagnostic-instructions.product-proving-packs-protocol.md`
...
4. `docs/framework/research/agentic-proof-obligation-registry.md`
5. `docs/framework/research/vida-1.0-agent-runtime-external-alignment.md`
...
schema_version: '1'
status: canonical
source_path: vida/config/instructions/runtime-instructions.verification-lane-protocol.md
created_at: '2026-03-10T15:05:00+02:00'
updated_at: '2026-03-10T14:41:13+02:00'
changelog_ref: runtime-instructions.verification-lane-protocol.changelog.jsonl
