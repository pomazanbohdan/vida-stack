...
2. `vida/config/instructions/instruction-contracts.autonomous-execution-protocol.md`
3. `vida/config/instructions/instruction-contracts.agent-system-protocol.md`
4. `vida/config/instructions/runtime-instructions.spec-sync-protocol.md`
5. `vida/config/instructions/runtime-instructions.task-approval-loop-protocol.md`
6. `vida/config/instructions/diagnostic-instructions.debug-escalation-protocol.md`
...
schema_version: 1
status: canonical
source_path: vida/config/instructions/diagnostic-instructions.protocol-self-diagnosis-protocol.md
created_at: 2026-03-09T12:00:46+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: diagnostic-instructions.protocol-self-diagnosis-protocol.changelog.jsonl
