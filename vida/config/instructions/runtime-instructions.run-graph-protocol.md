...
Purpose: persist durable node-level orchestration state for one routed execution run beyond TaskFlow checkpoints and task lifecycle state.

## Core Contract

1. Task lifecycle stays in `br`.
2. TaskFlow remains execution telemetry.
...
schema_version: 1
status: canonical
source_path: vida/config/instructions/runtime-instructions.run-graph-protocol.md
created_at: 2026-03-08T02:15:22+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: runtime-instructions.run-graph-protocol.changelog.jsonl
