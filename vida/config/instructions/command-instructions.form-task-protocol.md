...
6. hand off execution only to `vida/config/instructions/command-instructions.implement-execution-protocol.md`.
...
1.1. Equivalent bugfix paths may use approved `issue_contract` input from `vida/config/instructions/runtime-instructions.issue-contract-protocol.md` instead of a longer SCP artifact when the scope is already bounded.
...
6. WVP evidence for external assumptions (`vida/config/instructions/runtime-instructions.web-validation-protocol.md`).
...
1. `/vida-implement` must run by `vida/config/instructions/command-instructions.implement-execution-protocol.md` only.
...
schema_version: 1
status: canonical
source_path: vida/config/instructions/command-instructions.form-task-protocol.md
created_at: 2026-03-06T22:42:30+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: command-instructions.form-task-protocol.changelog.jsonl
