...
Purpose: framework-facing maintained reference for the worker-packet template home after flat canonical path restoration.
...
changelog_ref: worker.packet-templates.changelog.jsonl
