...
2. Keep `Deep Spec` in `vida/config/instructions/instruction-contracts.thinking-protocol.md` as canonical.
...
changelog_ref: references.algorithms-quick-reference.changelog.jsonl
