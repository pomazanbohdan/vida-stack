...
| Role profile contract | `agent-definitions/role.role-profile-contract` | `agent-definitions/model.agent-definitions-contract`, `docs/product/spec/instruction-artifact-model.md`, `Git history and active artifact sidecars` |
...
| Project agent extension | `runtime-instructions/work.project-agent-extension-protocol` | `vida.config.yaml`, `docs/process/agent-extensions/index.md`, `docs/product/spec/agent-role-skill-profile-flow-model.md`, `instruction-contracts/core.agent-system-protocol`, `system-maps/runtime-family.taskflow-map` |
...
| DB-first runtime ownership | `Git history and active artifact sidecars` | `Git history and active artifact sidecars`, `Git history and active artifact sidecars`, `runtime-instructions/runtime.export-protocol` |
| Export surfaces | `runtime-instructions/runtime.export-protocol` | `Git history and active artifact sidecars`, `Git history and active artifact sidecars` |
...
| Direct runtime consumption | `runtime-instructions/runtime.direct-runtime-consumption-protocol` | `system-maps/runtime-family.taskflow-map`, `system-maps/runtime-family.docflow-map`, `Git history and active artifact sidecars` |
...
| Future platform alignment (non-canonical reference) | `Git history and active artifact sidecars` | `system-maps/framework.index`, `sidecar changelog plus Git history` |
...
| Shared reference catalog (non-runtime) | `docs/project-root-map.md` | `docs/product/index.md`, `docs/process/index.md`, `docs/project-memory/index.md` |
...
| VIDA migration/source lineage (non-canonical reference) | `Git history and active artifact sidecars` | `system-maps/framework.map`, `docs/product/spec/current-spec-map.md` |
| Agent-system activation/routing | `instruction-contracts/core.agent-system-protocol` | `system-maps/runtime-family.taskflow-map`, `vida.config.yaml`, `docs/process/agent-system.md`, `agent-backends/matrix.agent-backends-matrix` |
...
| Project operations docs | host-project operations doc declared by the active project overlay when overlay exists | `docs/process/index.md`, `docs/process/project-orchestrator-operating-protocol.md`, `docs/process/project-development-packet-template-protocol.md`, `docs/process/project-agent-prompt-stack-protocol.md`, `docs/process/project-orchestrator-session-start-protocol.md`, `scripts/` |
