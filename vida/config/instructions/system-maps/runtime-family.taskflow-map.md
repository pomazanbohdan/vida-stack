...
4. governing framework protocols:
   ...
   - `vida/config/instructions/system-maps/migration.runtime-transition-map.md`
   - `vida/config/instructions/system-maps/migration.script-runtime-architecture-map.md`
   - `vida/config/instructions/runtime-instructions/lane.agent-handoff-context-protocol.md`
   - `vida/config/instructions/runtime-instructions/recovery.checkpoint-replay-recovery-protocol.md`
   - `vida/config/instructions/runtime-instructions/work.verification-lane-protocol.md`
   - `vida/config/instructions/runtime-instructions/runtime.runtime-kernel-bundle-protocol.md`
   - `vida/config/instructions/runtime-instructions/work.verification-merge-protocol.md`
   - `vida/config/instructions/runtime-instructions/runtime.direct-runtime-consumption-protocol.md`
...
5. Handoff/context shaping:
   - continue to `vida/config/instructions/runtime-instructions/lane.agent-handoff-context-protocol.md`
6. Checkpoint, replay, or recovery:
   - continue to `vida/config/instructions/runtime-instructions/recovery.checkpoint-replay-recovery-protocol.md`
7. Verification/proving lane behavior:
   - continue to `vida/config/instructions/runtime-instructions/work.verification-lane-protocol.md`
8. Runtime kernel bundle composition:
   - continue to `vida/config/instructions/runtime-instructions/runtime.runtime-kernel-bundle-protocol.md`
9. Verification merge/admissibility:
   - continue to `vida/config/instructions/runtime-instructions/work.verification-merge-protocol.md`
...
11. Final runtime-consumption activation and closure handoff:
   - continue to `vida/config/instructions/runtime-instructions/runtime.direct-runtime-consumption-protocol.md`
...
12. Project role/skill/profile/flow extension activation:
   - continue to `vida/config/instructions/runtime-instructions/work.project-agent-extension-protocol.md`
