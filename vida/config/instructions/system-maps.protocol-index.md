...
| Documentation migration of any project toward Layer 7 closure | `vida/config/instructions/instruction-contracts.documentation-layer7-migration-protocol.md` | `vida/config/instructions/instruction-contracts.documentation-operation-protocol.md`, `vida/config/instructions/instruction-contracts.instruction-activation-protocol.md`, `docs/product/spec/canonical-documentation-and-inventory-layers.md`, `docs/product/spec/canonical-layer-documentation-template.md`, `AGENTS.sidecar.md`, `codex-v0/codex.py` |
