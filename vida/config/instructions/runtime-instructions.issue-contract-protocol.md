...
3. Works with `vida/config/instructions/command-instructions.bug-fix-protocol.md`, `vida/config/instructions/command-instructions.implement-execution-protocol.md`, and `vida/config/instructions/instruction-contracts.agent-system-protocol.md`.
4. Consumes `vida/config/instructions/runtime-instructions.spec-intake-protocol.md` when an incoming issue/release signal is still too mixed or scope-bearing for direct issue-contract narrowing.
...
1. run `vida/config/instructions/runtime-instructions.web-validation-protocol.md`,
...
When `status=spec_delta_required`, materialize the delta via `vida/config/instructions/runtime-instructions.spec-delta-protocol.md` instead of leaving the reconciliation request implicit.
...
-----
artifact_path: config/runtime-instructions/issue-contract.protocol
artifact_type: runtime_instruction
artifact_version: 1
artifact_revision: 2026-03-09
schema_version: 1
status: canonical
source_path: vida/config/instructions/runtime-instructions.issue-contract-protocol.md
created_at: 2026-03-07T19:09:33+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: runtime-instructions.issue-contract-protocol.changelog.jsonl
