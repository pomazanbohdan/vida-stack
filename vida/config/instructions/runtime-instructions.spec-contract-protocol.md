...
3. Raw issue text for bugfix execution is normalized by `vida/config/instructions/runtime-instructions.issue-contract-protocol.md` instead of running full SCP by default.
4. Raw research findings, release signals, and user clarification should first be normalized by `vida/config/instructions/runtime-instructions.spec-intake-protocol.md` when they are still ambiguous, mixed, or scope-bearing.
...
0. `SCP-0 Pre-Intake Normalization`
   - when raw inputs are still ambiguous or mixed, normalize them through `vida/config/instructions/runtime-instructions.spec-intake-protocol.md`,
...
4. `SCP-3 External Reality Validation`
   - Execute `vida/config/instructions/runtime-instructions.web-validation-protocol.md` (WVP) as canonical validation flow.
...
Canonical rules are defined in `vida/config/instructions/runtime-instructions.web-validation-protocol.md`.
...
## SCP -> FTP/TaskFlow Handoff Contract

SCP output must be planning-ready for `/vida-form-task` and TaskFlow decomposition.
...
Artifact templates: `vida/config/instructions/system-maps.spec-contract-artifacts.md`
...
-----
artifact_path: config/runtime-instructions/spec-contract.protocol
artifact_type: runtime_instruction
artifact_version: 1
artifact_revision: 2026-03-09
schema_version: 1
status: canonical
source_path: vida/config/instructions/runtime-instructions.spec-contract-protocol.md
created_at: 2026-03-06T22:42:30+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: runtime-instructions.spec-contract-protocol.changelog.jsonl
