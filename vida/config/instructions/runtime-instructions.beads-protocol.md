...
1. When `br` lifecycle state and TaskFlow execution state diverge, use `vida/config/instructions/runtime-instructions.task-state-reconciliation-protocol.md` to classify the task before mutating lifecycle state.
