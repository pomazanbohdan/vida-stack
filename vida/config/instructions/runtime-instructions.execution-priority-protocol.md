...
3. works together with `vida/config/instructions/command-instructions.form-task-protocol.md`, `vida/config/instructions/runtime-instructions.taskflow-protocol.md`, `vida/config/instructions/command-instructions.implement-execution-protocol.md`, and `vida/config/instructions/instruction-contracts.autonomous-execution-protocol.md`.
...
4. approved scope/order contract from `vida/config/instructions/command-instructions.form-task-protocol.md`,
...
When `vida/config/instructions/instruction-contracts.autonomous-execution-protocol.md` is active:
...
schema_version: 1
status: canonical
source_path: vida/config/instructions/runtime-instructions.execution-priority-protocol.md
created_at: 2026-03-09T12:00:46+02:00
updated_at: 2026-03-10T00:55:00+02:00
changelog_ref: runtime-instructions.execution-priority-protocol.changelog.jsonl
