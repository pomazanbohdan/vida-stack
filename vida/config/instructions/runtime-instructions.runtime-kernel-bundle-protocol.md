...
5. `docs/product/spec/partial-development-kernel-scope.md`
6. `docs/product/spec/canonical-machine-map.md`
7. `docs/product/spec/receipt-proof-taxonomy.md`
...
2. `vida/config/instructions/runtime-instructions.agent-role-selection-protocol.md`
3. `vida/config/instructions/runtime-instructions.project-agent-extension-protocol.md`
...
schema_version: '1'
status: canonical
source_path: vida/config/instructions/runtime-instructions.runtime-kernel-bundle-protocol.md
created_at: '2026-03-10T16:00:00+02:00'
updated_at: '2026-03-10T17:22:42+02:00'
changelog_ref: runtime-instructions.runtime-kernel-bundle-protocol.changelog.jsonl
