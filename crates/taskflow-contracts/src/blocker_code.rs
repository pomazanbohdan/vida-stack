...
pub enum BlockerCode {
    ...
    PackFlowRegistryMissing,
    PackFlowRegistryMissingFlowSets,
    ...
    HostBridgeResultContractInvalid,
    HostBridgeResultTransitionMismatch,
...
impl BlockerCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::PackFlowRegistryMissing => "pack_flow_registry_missing",
            Self::PackFlowRegistryMissingFlowSets => "pack_flow_registry_missing_flow_sets",
            ...
            Self::HostBridgeResultContractInvalid => "host_bridge_result_contract_invalid",
            Self::HostBridgeResultTransitionMismatch => "host_bridge_result_transition_mismatch",
    ...
    pub const fn all() -> &'static [Self] {
        &[
            ...
            Self::PackFlowRegistryMissing,
            Self::PackFlowRegistryMissingFlowSets,
            ...
            Self::HostBridgeResultContractInvalid,
            Self::HostBridgeResultTransitionMismatch,
