...
fn task_update_parent_guard_quotes_shell_unsafe_issue_id_in_next_action() {
    ...
    assert_eq!(
        run_command_json(
            &[
                "task", "create", old_parent_id, "Old parent", "--type", "epic", "--status",
                "closed", "--json",
            ],
            &state_dir,
        )["status"],
    ...
    assert_eq!(
        run_command_json(
            &[
                "task", "create", "closed-child-shell-quote", "Closed child", "--type",
                "defect", "--status", "closed", "--parent-id", old_parent_id, "--json",
            ],
            &state_dir,
        )["status"],
        "pass"
    ...
    assert_eq!(
        run_command_json(
            &[
                "task", "create", open_child_id, "Open child", "--type", "defect", "--status",
                "open", "--parent-id", old_parent_id, "--json",
            ],
            &state_dir,
        )["status"],
        "pass"
    ...
    assert_eq!(
        run_command_json(
            &[
                "task", "create", new_parent_id, "New parent", "--type", "epic", "--json",
            ],
            &state_dir,
        )["status"],
        "pass"
    ...
    assert!(
        parsed["next_actions"]
            ...
            .any(|action| action
                .contains("vida task update 'old;echo pwned' --status closed --json")),
        "{parsed}"
    );
