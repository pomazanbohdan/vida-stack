...
mod tests {
    ...
    fn host_bridge_adapter_completion_command_omits_untrusted_packet_next_node() {
        ...
        assert!(completion_command
            .contains("--receipt-id run-analyst-analyst-req-analyst-packet-host-bridge-receipt"));
        assert!(!completion_command
    ...
    fn host_bridge_submit_result_direct_developer_role_selection(
        ...
        selection.execution_plan["development_flow"]["dispatch_contract"]
            ["execution_lane_sequence"] = serde_json::json!(execution_lane_sequence);
    ...
    fn flow_projection_projects_canonical_step_gate_and_rework_policy() {
        ...
        assert!(preview.flow_projection["approval_waits"]
            .as_array()
