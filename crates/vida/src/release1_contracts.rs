...
impl BlockerCode {
    pub(crate) const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::MissingOwnedWriteScope => "missing_owned_write_scope",
            Self::MigrationRequired => "migration_required",
            ...
            Self::PendingAutotestEvidence => "pending_autotest_evidence",
    ...
    pub(crate) fn from_str(value: &str) -> Option<Self> {
        match value {
            ...
            "missing_owned_write_scope" => Some(Self::MissingOwnedWriteScope),
            "migration_required" => Some(Self::MigrationRequired),
            ...
            "pending_autotest_evidence" => Some(Self::PendingAutotestEvidence),
...
const EXTENDED_BLOCKER_CODE_STRINGS: &[&str] = &[
    "active_step_orchestrator_projection_mismatch",
    "active_step_parent_task_missing",
    ...
    "external_provider_cooldown_active",
    "graph_blocked",
    "host_bridge_completion_outcome_contradiction",
    "host_bridge_completion_result_blocked",
    "host_bridge_result_decision_verdict_mismatch",
    "host_bridge_result_artifact_kind_invalid",
    "host_bridge_result_execution_evidence_not_receipt_backed",
    "host_bridge_result_unreadable",
    "isolated_worktree_canonical_worktree_evidence_missing",
    "isolated_worktree_canonical_worktree_touched",
    "invalid_allowed_next_node_for_execution_plan",
    "invalid_lanes_requested",
    "invalid_zombie_d_gate_id",
    "invalid_zombie_d_required_categories",
    "missing_acceptance_targets",
    "missing_configured_dispatch_command",
    "missing_dependency",
    ...
    "missing_owned_paths",
    "missing_parent",
    "missing_docflow_proofcheck",
    "missing_docflow_readiness_check",
    "missing_prepush_gate_scope",
    ...
    "order_bucket_evidence_required",
    "optional_task_worktree_assignment_projection_unavailable",
    "pack_catalog_empty",
    "parallel_group_evidence_required",
    "pending_analysis_evidence",
    "pending_design_evidence",
    "pending_test_author_evidence",
    "pricing_import_mode_conflict",
    "pricing_import_source_file_required",
    "protocol_rule_violation",
    ...
    "task_class_binding_missing",
    "team_flow_authority_design_owner_missing",
    "team_flow_authority_flow_id_missing",
    "team_flow_authority_persisted_flows_missing",
    "team_flow_authority_team_flow_enabled_missing",
    "team_flow_authority_work_item_flow_bindings_missing",
    "team_flow_receipt_id_mismatch",
    "team_flow_receipt_id_missing",
    ...
    "empty_zombie_d_enforcement_points",
    "empty_zombie_d_path_tokens",
    "empty_zombie_d_task_classes",
    "zombie_d_categories_missing",
    "zombie_d_doubt_unresolved",
    "zombie_d_matrix_metadata_missing",
    "zombie_d_matrix_metadata_schema_invalid",
    "zombie_d_matrix_schema_invalid",
    "zombie_d_quality_gate_doubt_unresolved",
    "zombie_d_quality_gate_doubts_invalid",
    "zombie_d_quality_gate_passed_marker",
    "zombie_d_quality_gate_schema_invalid",
    "zombie_d_quality_gate_verdict_marker",
];
