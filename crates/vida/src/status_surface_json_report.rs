...
pub(crate) struct StatusJsonReportInputs<'a> {
    ...
    pub(crate) latest_terminal_task_active_run_graph_status:
        Option<&'a crate::state_store::RunGraphStatus>,
...
pub(crate) fn build_status_json_report(
    ...
    let mut summary_json = if inputs.summary_only {
        serde_json::json!({
            ...
            "latest_terminal_task_active_run_graph_status": inputs.latest_terminal_task_active_run_graph_status,
...
mod tests {
    ...
    fn build_status_json_report_keeps_enrichment_nested_and_drops_raw_top_level_mirrors() {
        ...
        let summary_json = super::build_status_json_report(super::StatusJsonReportInputs {
            ...
            latest_terminal_task_active_run_graph_status: None,
