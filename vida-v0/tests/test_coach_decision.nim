    ...
    let output = """
{
  ...
  "evidence_refs": ["docs/framework/history/_vida-source/scripts/quality-health-check.sh:280"],
  "changed_files": [],
  "verification_commands": ["bash docs/framework/history/_vida-source/scripts/quality-health-check.sh --mode quick unit-task"],
  ...
  "impact_analysis": {
    "affected_scope": ["docs/framework/history/_vida-source/scripts/quality-health-check.sh"],
    ...
    let output = """
{
  ...
  "question_answered": "yes",
  "answer": "looks fine",
  "evidence_refs": ["docs/framework/history/_vida-source/scripts/subagent-dispatch.py:2442"],
  "changed_files": [],
    ...
    let output = """
{
  ...
  "impact_analysis": {
    "affected_scope": ["docs/framework/history/_vida-source/scripts/subagent-dispatch.py"],
    "contract_impact": [],
    "follow_up_actions": [],
    "residual_risks": []
  },
