...
1. Use `_vida/docs/web-validation-protocol.md` as canonical internet validation standard.
...
4. Apply `_vida/docs/spec-contract-protocol.md` gates for this non-development flow.
...
2. `docs/decisions.md`
3. `/vida-spec`
4. `_vida/docs/use-case-packs.md`
