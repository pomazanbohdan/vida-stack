...
2. applies to TODO/`br` task selection, wave ordering, and in-session reprioritization,
3. works together with `_vida/docs/form-task-protocol.md`, `_vida/docs/todo-protocol.md`, `_vida/docs/implement-execution-protocol.md`, and `_vida/docs/autonomous-execution-protocol.md`.
...
2. active TODO block and `next_step`,
3. `br` lifecycle state and dependency state,
4. approved scope/order contract from `_vida/docs/form-task-protocol.md`,
...
4. record the reason in TODO evidence or task notes,
...
When `_vida/docs/autonomous-execution-protocol.md` is active:
...
2. ignoring the active TODO block because another task is already open,
