...
```bash
python3 _vida/scripts/doc-lifecycle.py record <path> <proposed|current|superseded|deprecated|stale> --owner "<owner>" --notes "<notes>"
python3 _vida/scripts/doc-lifecycle.py validate <path> [--max-age-days N]
python3 _vida/scripts/doc-lifecycle.py status
```
...
1. This protocol governs framework-owned documents first (`AGENTS.md`, `_vida/docs/*`, synced framework templates/overlays when applicable).
