# Subagent Thinking Contract

Purpose: provide a compact worker-safe subset of VIDA thinking algorithms for delegated and external subagents.

This file is for worker lanes only.
