...
### 1. Durable run graph beyond TODO/task checkpoints

Current local evidence:

1. boot receipts, TODO checkpoints, and context capsules exist,
...
1. `_vida/scripts/eval-pack.sh`,
2. `_vida/scripts/subagent-eval-pack.py`,
...
3. Any task taken from `Locally remaining` should be tracked through normal framework TODO/`br` flow and verified against current workspace evidence.
