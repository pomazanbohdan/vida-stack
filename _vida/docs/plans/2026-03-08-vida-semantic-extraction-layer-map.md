...
1. `_vida/docs/instruction-activation-protocol.md`
...
1. `_vida/docs/project-overlay-protocol.md`
2. `vida.config.yaml`
...
1. `bash _vida/scripts/...` as the long-term operator surface
2. shell-specific argument plumbing

Current sources:

1. `AGENTS.md`
2. `_vida/docs/command-layer-protocol.md`
3. `_vida/docs/orchestration-protocol.md`
4. `_vida/docs/beads-protocol.md`
...
1. `_vida/docs/beads-protocol.md`
2. `_vida/docs/todo-protocol.md`
3. `_vida/docs/human-approval-protocol.md`
...
1. `_vida/docs/beads-protocol.md`
2. `_vida/docs/task-state-reconciliation-protocol.md`
...
1. `_vida/docs/human-approval-protocol.md`
2. `_vida/docs/run-graph-protocol.md`
3. `_vida/docs/boot-packet-protocol.md`
4. `_vida/docs/context-governance-protocol.md`
5. `_vida/docs/beads-protocol.md`
6. `_vida/docs/subagent-system-protocol.md`
...
2. `_vida/docs/ORCHESTRATOR-ENTRY.MD`
3. `_vida/docs/orchestration-protocol.md`
4. `_vida/docs/implement-execution-protocol.md`
...
1. `_vida/docs/subagent-system-protocol.md`
2. `_vida/docs/human-approval-protocol.md`
3. `_vida/docs/product-proving-packs-protocol.md`
4. `_vida/docs/trace-eval-protocol.md`
...
4. `_vida/docs/research/2026-03-08-agentic-epic-slicing-agent-instruction.md`
...
1. `_vida/docs/run-graph-protocol.md`
2. `_vida/docs/beads-protocol.md`
3. `_vida/docs/context-governance-protocol.md`
...
1. `_vida/docs/framework-memory-protocol.md`
2. `_vida/docs/document-lifecycle-protocol.md`
3. `_vida/docs/silent-framework-diagnosis-protocol.md`
...
1. `_vida/docs/trace-eval-protocol.md`
2. `_vida/docs/research/2026-03-08-agentic-metric-glossary.md`
3. `_vida/docs/research/2026-03-08-agentic-proof-obligation-registry.md`
...
1. `_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
