...
7. `_vida/docs/research/2026-03-08-vida-instruction-kernel-next-step-after-compact-instruction.md`
8. `_vida/docs/plans/2026-03-08-vida-0.3-command-tree-spec.md`
9. `_vida/docs/plans/2026-03-08-vida-0.3-state-kernel-schema-spec.md`
10. `_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
11. `_vida/docs/plans/2026-03-08-vida-semantic-extraction-layer-map.md`
12. `_vida/docs/plans/2026-03-08-vida-0.2-semantic-freeze-spec.md`
13. `_vida/docs/plans/2026-03-08-vida-0.2-bridge-policy.md`
14. `_vida/docs/plans/2026-03-08-vida-direct-1.0-local-spec-program.md`
15. `_vida/docs/research/2026-03-08-agentic-agent-definition-system.md`
16. `_vida/docs/agent-definition-protocol.md`
17. `_vida/templates/instruction-contract.yaml`
18. `_vida/templates/prompt-template-config.yaml`
19. `_vida/docs/project-overlay-protocol.md`
20. `_vida/docs/instruction-activation-protocol.md`
21. `_vida/docs/subagent-system-protocol.md`
22. `_vida/docs/framework-memory-protocol.md`
23. `_vida/docs/silent-framework-diagnosis-protocol.md`
...
3. raw subagent output is not the default user-facing deliverable when orchestrator synthesis is required.
...
1. `_vida/docs/plans/2026-03-08-vida-0.3-migration-kernel-spec.md`
