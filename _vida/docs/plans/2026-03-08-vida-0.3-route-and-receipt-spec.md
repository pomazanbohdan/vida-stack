...
7. `_vida/docs/research/2026-03-08-vida-route-and-receipt-next-step-after-compact-instruction.md`
8. `_vida/docs/plans/2026-03-08-vida-direct-1.0-compact-continuation-plan.md`
9. `_vida/docs/plans/2026-03-08-vida-0.3-command-tree-spec.md`
10. `_vida/docs/plans/2026-03-08-vida-0.3-state-kernel-schema-spec.md`
11. `_vida/docs/plans/2026-03-08-vida-0.3-instruction-kernel-spec.md`
12. `_vida/docs/plans/2026-03-08-vida-0.3-migration-kernel-spec.md`
13. `_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
...
17. `_vida/docs/subagent-system-protocol.md`
...
5. the subagent system protocol supplies the minimum route-stage and fail-closed authorization semantics.
...
Analysis is evidence-forming, bounded, and may use fanout or read-only subagent lanes when authorized.
...
3. keep raw subagent output as evidence, not as the default final deliverable.
...
6. Raw subagent output is evidence, not the default final deliverable.
