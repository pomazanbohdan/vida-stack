...
2. If worker-lane confirmation is absent or ambiguous, fall back to `_vida/docs/ORCHESTRATOR-ENTRY.MD`.
3. Preferred packet markers:
...
7. Use the worker-safe thinking subset from `_vida/docs/SUBAGENT-THINKING.MD`.
