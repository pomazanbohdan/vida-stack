...
3. for installer-managed runs, `docflow-v0` delegates to `<install-root>/current/.venv/bin/python3 <install-root>/current/codex-v0/codex.py`
...
1. `dist/vida-stack-v0.2.0.tar.gz`
2. `dist/vida-stack-v0.2.0.zip`
3. `dist/vida-install.sh`
4. `dist/package/vida-stack-v0.2.0/release-manifest.json`

Current release-manifest contract:

1. installed entrypoints are `vida`, `taskflow-v0`, `docflow-v0`
...
1. `bash dist/vida-install.sh install --archive dist/vida-stack-v0.2.0.tar.gz --root <tmp-root> --bin-dir <tmp-bin> --force`
...
3. makes `vida`, `taskflow-v0`, and `docflow-v0` executable from `PATH`
...
updated_at: '2026-03-12T08:54:26+02:00'
