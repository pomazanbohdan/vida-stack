...
18. use `vida taskflow bootstrap-spec "<request>"` as the preferred one-shot launcher surface when a design-first feature request must materialize the initial feature epic, spec-pack task, and canonical design-doc scaffold in one pass.
