...
4. `vida/config/instructions/agent_definitions/`
5. `vida/config/instructions/instruction_contracts/`
6. `vida/config/instructions/prompt_templates/`
...
3. `docs/framework/role-profile-protocol.md` when role profiles are implemented
