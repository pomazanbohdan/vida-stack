...
3. Bridges `docs/framework/spec-intake-protocol.md`, `docs/framework/spec-contract-protocol.md`, `docs/framework/form-task-protocol.md`, and `docs/framework/issue-contract-protocol.md`.
...
1. `delta_ready` -> `docs/framework/spec-contract-protocol.md`
