...
Use when: context was compacted and the next work is to continue `/home/unnamed/project/mobile-odoo/_vida/docs/plans/2026-03-08-vida-0.3-route-and-receipt-spec.md` with `Part B` scope only.
...
## Role
  ...
  `/home/unnamed/project/mobile-odoo/_vida/docs/plans/2026-03-08-vida-0.3-route-and-receipt-spec.md`
  </role>
  ...
  13. `/home/unnamed/project/mobile-odoo/_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
  ...
  17. `/home/unnamed/project/mobile-odoo/_vida/docs/subagent-system-protocol.md`
  </required_read_order>
  ...
  1. `Parity/Conformance Part A` against `/home/unnamed/project/mobile-odoo/_vida/docs/plans/2026-03-08-vida-0.3-parity-and-conformance-spec.md`
