...
**Tech Stack:** Markdown protocols, instruction contracts, YAML templates/config, Python runtime helpers, shell wrappers, local execution receipts, web-search-based research refresh, `_vida/tests/*` proof surfaces, `br` task state, TODO telemetry.
...
- `_vida/docs/research/2026-03-08-agentic-role-profile-source-registry.md`
- `_vida/docs/research/2026-03-08-agentic-role-profile-source-delta-log.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research/2026-03-08-agentic-role-profile-source-registry.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research/2026-03-08-agentic-role-profile-source-delta-log.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research-refresh-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/role-taxonomy-protocol.md`
- Modify: `/home/unnamed/project/mobile-odoo/docs/process/agent-system.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/role-profile-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/templates/role-profile-card.yaml`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_role_profile_schema.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/thinking-tone-axes.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/role-profile-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/task-classification-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/scripts/task-classify.py`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_task_classification.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/task-score-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/scripts/task-score.py`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_task_score.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/adaptive-agent-count-protocol.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/subagent-system-protocol.md`
- Modify: `/home/unnamed/project/mobile-odoo/vida.config.yaml`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_adaptive_agent_count.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/consensus-orchestration-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/scripts/consensus-merge.py`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_consensus_merge.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/autonomous-task-packet-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/templates/autonomous-task-packet.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_task_packet_contract.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/context-handoff-protocol.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/research-refresh-protocol.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/autonomous-task-packet-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/role-compatibility-matrix.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/role-taxonomy-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/verification-burden-matrix.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/implement-execution-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/owasp-agent-security-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/docs/process/owasp-vida-mapping.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/verification-burden-matrix.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/role-profile-protocol.md`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/adaptive-orchestration-trace-schema.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/run-graph-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_trace_schema.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research/2026-03-08-agentic-role-profile-eval-plan.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/agentic-eval-protocol.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/tests/test_eval_protocol_contract.py`
...
**Files:**
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research/2026-03-08-agentic-master-index.md`
- Create: `/home/unnamed/project/mobile-odoo/_vida/docs/research/2026-03-08-agentic-epic-slicing-agent-instruction.md`
- Modify: `/home/unnamed/project/mobile-odoo/_vida/docs/plans/2026-03-08-vida-autonomous-role-profiles-and-adaptive-orchestration-plan.md`
...
4. `Input Artifacts`
   - `_vida/docs/research/2026-03-08-agentic-role-profile-source-registry.md`
   - `_vida/docs/research/2026-03-08-agentic-role-profile-source-delta-log.md`
   - `_vida/docs/task-classification-protocol.md`
   - `_vida/docs/task-score-protocol.md`
   - `_vida/docs/role-taxonomy-protocol.md`
5. `Output Artifacts`
   - protocol doc
   - config changes
   - tests
