...
3. `_vida/docs/plans/2026-03-08-vida-direct-1.0-local-spec-program.md`
...
1. `bash _vida/scripts/...` as the canonical operator surface,
...
7. current CLI subagent transport as the only orchestration transport,
...
1. `_vida/docs/plans/2026-03-08-vida-0.2-bridge-policy.md`
2. `_vida/docs/plans/2026-03-08-vida-0.3-command-tree-spec.md`
3. `_vida/docs/plans/2026-03-08-vida-0.3-state-kernel-schema-spec.md`
4. `_vida/docs/plans/2026-03-08-vida-0.3-instruction-kernel-spec.md`
5. `_vida/docs/plans/2026-03-08-vida-0.3-migration-kernel-spec.md`
6. `_vida/docs/plans/2026-03-08-vida-0.3-route-and-receipt-spec.md`
7. `_vida/docs/plans/2026-03-08-vida-0.3-parity-and-conformance-spec.md`
...
3. `_vida/docs/instruction-activation-protocol.md`
4. `_vida/docs/project-overlay-protocol.md`
5. `_vida/docs/command-layer-protocol.md`
6. `_vida/docs/orchestration-protocol.md`
7. `_vida/docs/protocol-index.md`
8. `_vida/docs/beads-protocol.md`
9. `_vida/docs/todo-protocol.md`
10. `_vida/docs/task-state-reconciliation-protocol.md`
11. `_vida/docs/human-approval-protocol.md`
12. `_vida/docs/subagent-system-protocol.md`
13. `_vida/docs/run-graph-protocol.md`
14. `_vida/docs/framework-memory-protocol.md`
15. `_vida/docs/silent-framework-diagnosis-protocol.md`
16. `_vida/docs/web-validation-protocol.md`
17. `_vida/docs/context-governance-protocol.md`
18. `_vida/docs/agent-definition-protocol.md`
19. `_vida/templates/instruction-contract.yaml`
20. `_vida/templates/prompt-template-config.yaml`
21. `_vida/docs/plans/2026-03-08-vida-semantic-extraction-layer-map.md`
22. `_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
23. `_vida/docs/plans/2026-03-08-vida-direct-1.0-local-spec-program.md`
24. `_vida/docs/research/2026-03-08-agentic-agent-definition-system.md`
25. `_vida/docs/research/2026-03-08-agentic-proof-obligation-registry.md`
26. `_vida/docs/research/2026-03-08-agentic-metric-glossary.md`
