...
2. `_vida/scripts/*.sh|*.py` entrypoints,
...
3. `_vida/docs/command-layer-protocol.md`
4. `_vida/docs/orchestration-protocol.md`
5. `_vida/docs/protocol-index.md`
6. `_vida/docs/agent-definition-protocol.md`
7. `_vida/docs/framework-memory-protocol.md`
8. `_vida/docs/silent-framework-diagnosis-protocol.md`
9. `_vida/commands.md`
10. `_vida/commands/vida-research.md`
11. `_vida/commands/vida-spec.md`
12. `_vida/commands/vida-form-task.md`
13. `_vida/commands/vida-implement.md`
14. `_vida/commands/vida-bug-fix.md`
15. `_vida/commands/vida-status.md`
16. `_vida/docs/plans/2026-03-08-vida-0.1-to-1.0-direct-binary-transition-plan.md`
17. `_vida/docs/plans/2026-03-08-vida-semantic-extraction-layer-map.md`
18. `_vida/docs/plans/2026-03-08-vida-0.2-semantic-freeze-spec.md`
19. `_vida/docs/plans/2026-03-08-vida-0.2-bridge-policy.md`
20. `_vida/docs/plans/2026-03-08-vida-direct-1.0-local-spec-program.md`
...
|---|---|---|---|
| boot snapshot + bootstrap router | `vida boot` | boot boundary, compact resume, startup guidance | `python3 _vida/scripts/vida-boot-snapshot.py`, `boot-profile.sh`, receipt file names |
| `/vida-status` + operator status surfaces | `vida status` | read-only operator visibility | `bash _vida/scripts/vida-status.sh`, `br ... --json`, tmp-file choreography |
...
1. `_vida/commands.md` or `_vida/commands/vida-*.md` as product command topology,
2. `bash _vida/scripts/...` or `python3 _vida/scripts/...` entrypoints,
...
8. current CLI-only subagent transport strings,
...
1. `_vida/docs/plans/2026-03-08-vida-0.3-state-kernel-schema-spec.md`
