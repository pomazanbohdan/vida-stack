...
3. Bridges `_vida/docs/spec-intake-protocol.md`, `_vida/docs/spec-contract-protocol.md`, `_vida/docs/form-task-protocol.md`, and `_vida/docs/issue-contract-protocol.md`.
...
1. `delta_ready` -> `_vida/docs/spec-contract-protocol.md`
...
```bash
python3 _vida/scripts/spec-delta.py write <task_id> <input.json> [--output PATH]
python3 _vida/scripts/spec-delta.py validate <task_id> [--path PATH]
python3 _vida/scripts/spec-delta.py status <task_id> [--path PATH]
```
