...
3. Used by `_vida/docs/thinking-protocol.md` and `_vida/docs/spec-contract-protocol.md` as single source.
...
1. `_vida/docs/thinking-protocol.md#section-web-search`: router-level trigger map and algorithm integration.
2. `_vida/docs/spec-contract-protocol.md`: SCP gates and weighted readiness model.
3. `_vida/docs/implement-execution-protocol.md`: execution-time validation before code decisions.
