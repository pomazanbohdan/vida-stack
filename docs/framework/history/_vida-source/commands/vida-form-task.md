...
4. `CL4 Materialization` -> `br` task-pool build plus dependency/track routing.
...
1. `_vida/docs/form-task-protocol.md`.
2. `_vida/docs/spec-contract-protocol.md`.
3. `_vida/docs/web-validation-protocol.md`.
4. `_vida/docs/beads-protocol.md`.
5. `_vida/docs/todo-protocol.md`.
6. `_vida/docs/implement-execution-protocol.md`.
7. `docs/decisions.md`.
...
Use `_vida/docs/form-task-protocol.md` question-card rules.
...
1. Run via TODO blocks and pack events.
...
1. `_vida/docs/form-task-protocol.md`
2. `_vida/docs/use-case-packs.md`
3. `_vida/docs/todo-protocol.md`
4. `_vida/commands/vida-spec.md`
5. `_vida/commands/vida-implement.md`
