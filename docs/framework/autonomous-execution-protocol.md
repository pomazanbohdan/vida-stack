...
5. active pool dependency graph under `docs/framework/implement-execution-protocol.md`.
...
2. apply `docs/framework/execution-priority-protocol.md` when choosing between multiple lawful next tasks or when reprioritization pressure exists,
...
7. reprioritization is implied but cannot be justified by `docs/framework/execution-priority-protocol.md`.
...
13. run `docs/framework/protocol-self-diagnosis-protocol.md` checks when behavior suggests reporting barriers, task-coverage drift, verification gaps, or route drift.
