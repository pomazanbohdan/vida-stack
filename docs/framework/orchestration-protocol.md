...
15.2. When the blocking problem is materially conflict-heavy but still bounded, prefer `docs/framework/problem-party-protocol.md` over ad hoc open-ended debate:
...
1. `docs/framework/use-case-packs.md`
