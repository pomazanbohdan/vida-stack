...
7. `docs/framework/research/vida-route-and-receipt-next-step-after-compact-instruction.md`
8. `docs/framework/plans/vida-direct-1.0-compact-continuation-plan.md`
9. `docs/framework/plans/vida-0.3-command-tree-spec.md`
10. `docs/framework/plans/vida-0.3-state-kernel-schema-spec.md`
11. `docs/framework/plans/vida-0.3-instruction-kernel-spec.md`
12. `docs/framework/plans/vida-0.3-migration-kernel-spec.md`
13. `docs/framework/plans/vida-0.1-to-1.0-direct-binary-transition-plan.md`
