...
3. `docs/framework/web-validation-protocol.md`
4. `docs/framework/issue-contract-protocol.md`
...
1. `docs/framework/task-state-reconciliation-protocol.md`
2. `docs/framework/silent-framework-diagnosis-protocol.md`
3. `docs/framework/framework-self-analysis-protocol.md`
4. `docs/framework/human-approval-protocol.md`
...
3. add it to `docs/framework/protocol-index.md`,
