...
1. run `docs/framework/web-validation-protocol.md`,
...
When `status=spec_delta_required`, materialize the delta via `docs/framework/spec-delta-protocol.md` instead of leaving the reconciliation request implicit.
