...
5. Scope: `AGENTS.md`, `docs/framework/*`, `docs/framework/history/_vida-source/scripts/*`, runtime logs, and only the project evidence that proves a framework-level friction point.
