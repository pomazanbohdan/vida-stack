...
1. Applies to `docs/framework/commands/vida-*.md`.
...
1. update this file,
2. update touched `docs/framework/commands/vida-*.md`,
3. update `docs/framework/protocol-index.md`,
4. update `docs/framework/framework-map-protocol.md` if framework topology language changes.

## Related

1. `docs/framework/commands.md`
2. `docs/framework/framework-map-protocol.md`
3. `docs/framework/protocol-index.md`
4. `docs/framework/commands/vida-research.md`
5. `docs/framework/commands/vida-spec.md`
6. `docs/framework/commands/vida-form-task.md`
7. `docs/framework/commands/vida-implement.md`
8. `docs/framework/commands/vida-bug-fix.md`
9. `docs/framework/commands/vida-status.md`
