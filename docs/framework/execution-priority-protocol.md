...
3. works together with `docs/framework/form-task-protocol.md`, `docs/framework/todo-protocol.md`, `docs/framework/implement-execution-protocol.md`, and `docs/framework/autonomous-execution-protocol.md`.
...
When `docs/framework/autonomous-execution-protocol.md` is active:
