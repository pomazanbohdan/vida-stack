...
Use when: context was compacted and the next artifact to create is `docs/framework/plans/vida-0.3-state-kernel-schema-spec.md`.
...
1. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-0.3-state-kernel-schema-spec.md`
...
8. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-0.1-to-1.0-direct-binary-transition-plan.md`
9. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-semantic-extraction-layer-map.md`
10. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-0.2-semantic-freeze-spec.md`
11. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-0.2-bridge-policy.md`
12. `/home/unnamed/project/vida-stack/docs/framework/plans/vida-direct-1.0-local-spec-program.md`
13. `/home/unnamed/project/vida-stack/vida/config/instructions/runtime-instructions.beads-protocol.md`
14. `/home/unnamed/project/vida-stack/vida/config/instructions/runtime-instructions.taskflow-protocol.md`
15. `/home/unnamed/project/vida-stack/vida/config/instructions/runtime-instructions.task-state-reconciliation-protocol.md`
16. `/home/unnamed/project/vida-stack/vida/config/instructions/runtime-instructions.run-graph-protocol.md`
17. `/home/unnamed/project/vida-stack/vida/config/instructions/runtime-instructions.human-approval-protocol.md`
18. `/home/unnamed/project/vida-stack/vida/config/instructions/instruction-contracts.agent-system-protocol.md`
