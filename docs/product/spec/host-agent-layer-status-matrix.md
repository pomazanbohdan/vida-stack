...
| `L3` | conversation-role to execution-role routing | `agent-lane-selection-and-conversation-mode-model.md`, `entry.orchestrator-entry.md` | `vida taskflow consume final|continue|advance`, `crates/vida/src/main.rs` | `green` |
